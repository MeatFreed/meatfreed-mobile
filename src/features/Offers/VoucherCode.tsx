...
export const VoucherCode: React.FC<VoucherCodeProps> = ({ code }) => {
  ...
  return (
    <Box m={[10, 16, 0]} p={[16]} ai="center" jc="center" br="16px" bgc={Colors.primary_100}>
      <Text fs={24} fnw="500" ff={FontFamily.PoppinsSemiMedium} color={Colors.primary_500}>{code}</Text>
